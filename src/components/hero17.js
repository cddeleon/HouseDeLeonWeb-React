            ...
            {props.content1 ?? (
              <Fragment>
                <span className="hero17-text5">
                  Explore our diverse portfolios and digital products. Connect
        ...
        <div className="hero17-actions">
          <button className="thq-button-filled hero17-button1">
            <span className="thq-body-small">
              {props.action1 ?? (
                <Fragment>
                  <span className="hero17-text8">Explore DevOps Portfolio</span>
                </Fragment>
              )}
            </span>
          </button>
...
Hero17.defaultProps = {
  ...
  image4Alt: 'Couples For Christ Moncton NB Chapter',
  image6Src:
  ...
  image3Alt: 'Digital Products Catalogue',
  image5Src:
  ...
  image1Alt: 'DevOps Developer Portfolio',
  ...
  image2Alt: 'HR Recruitment Officer Portfolio',
  action1: undefined,
}
