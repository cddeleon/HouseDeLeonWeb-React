                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text29">
                      Discover the impressive portfolio showcasing the skills
                      and projects of our talented DevOps Developer with
                      expertise in Python and Microsoft DevOps CI/CD.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text26">
                      Get to know our HR Recruitment Officer through their
                      stylish portfolio and learn about their experience and
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text25">
                      Explore our small and simple catalogue of digital products
                      for sale, with easy links to purchase directly on Etsy.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text28">
                      Experience a small sanctuary for the Moncton NB Chapter of
                      Couples For Christ, a Catholic-based charismatic community
