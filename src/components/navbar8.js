                            ...
                            {props.page1Description ?? (
                              <Fragment>
                                <span className="navbar8-text18">
                                  Explore the portfolio of a DevOps Developer
                                  with Python and Microsoft DevOps CI/CD
                                  skillset
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text25">
                                  Discover the stylish portfolio of an HR
                                  Recruitment officer with a half-body profile
                                  picture
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text16">
                                  Browse through a small and simple catalogue of
                                  digital products for sale that links to Etsy
                                </span>
                              </Fragment>
                            )}
                          </span>
                            ...
                            {props.page4Description ?? (
                              <Fragment>
                                <span className="navbar8-text17">
                                  Visit the small sanctuary for the Moncton NB
                                  Chapter of Couples For Christ, a
                                  Catholic-based charismatic community
                                </span>
                              </Fragment>
                            )}
                          </span>
                  ...
                  <div className="navbar8-content5">
                    ...
                    <span className="thq-body-small">
                      {props.page1Description ?? (
                        <Fragment>
                          <span className="navbar8-text18">
                            Explore the portfolio of a DevOps Developer with
                  ...
                  <div className="navbar8-content6">
                    ...
                    <span className="thq-body-small">
                      {props.page2Description ?? (
                        <Fragment>
                          <span className="navbar8-text25">
                            Discover the stylish portfolio of an HR Recruitment
                            officer with a half-body profile picture
                          </span>
                        </Fragment>
                      )}
                    </span>
                  ...
                  <div className="navbar8-content8">
                    ...
                    <span className="thq-body-small">
                      {props.page4Description ?? (
                        <Fragment>
                          <span className="navbar8-text17">
                            Visit the small sanctuary for the Moncton NB Chapter
                            of Couples For Christ, a Catholic-based charismatic
                            community
                          </span>
                        </Fragment>
                      )}
...
Navbar8.defaultProps = {
  ...
  page4ImageAlt: 'Couples For Christ Sanctuary Image',
  page3Description: undefined,
  page1ImageAlt: 'DevOps Developer Portfolio Image',
  page1ImageSrc:
  ...
  page3ImageAlt: 'Digital Products Catalogue Image',
  ...
  logoAlt: 'logo',
  page2ImageAlt: 'HR Recruitment Officer Portfolio Image',
  page1: undefined,
  action2: undefined,
  page3: undefined,
  page4: undefined,
